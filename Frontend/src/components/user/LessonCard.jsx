    ...
    return (
        <div className="flex-1 p-4 md:p-6 lg:p-8 bg-gray-50 min-h-screen">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600">All lessons ({filteredLessons.length} lessons)</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredLessons.length > 0 ? (
                    filteredLessons.map((Lesson) => (
                        <div
                            key={Lesson._id}
                            className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg hover:scale-102 transition-all duration-300 "
                        ...
                        >
                            ...
                            {/* Lesson Info */}
                            <div className="p-6">
                                <h3 className="text-lg font-semibold text-blue-800 mb-2 line-clamp-1">{Lesson.title}</h3>
                                <p className="text-gray-700 text-sm mb-4 line-clamp-2">{Lesson.description}</p>



                                <div className="flex items-center justify-end">
                                    <div className="flex items-center justify-end font-semibold cursor-pointer text-sm text-blue-700"
                                        onClick={() => handleLessonClick(Lesson.lessonlink)}
                                    >
