...
import {
  ...
  User, Settings, ChevronRight, Star, Clock, Users,
} from "lucide-react";
  ...
  return (
    <div className="flex-1 p-4 md:p-6 lg:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">All Tutorial ({filteredtutorials.length} tutorial)</p>
      </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-gray-500">
                    {React.createElement(iconMap[tutorial.icon], { size: 24 })}
                  </div>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center justify-end cursor-pointer font-semibold text-sm text-blue-700"
