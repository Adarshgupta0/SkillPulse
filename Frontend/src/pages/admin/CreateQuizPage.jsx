    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_BACKEND_URL}/admin/quiz-create`,
                quizdata,
                { withCredentials: true }
            );
            if (response.data.success) {
                reset();
                setAdminQuiz([response.data.quiz, ...adminquiz]);
                                    ...
                                    <div className="flex items-center justify-between mb-8">
                                        ...
                                        <div className='flex flex-col justify-center items-center gap-2'>
                                            ...
                                            <button
                                                ...
                                                disabled={loading}
                                                className={`flex items-center gap-2  text-white px-6 py-2 rounded-sm  ${loading ? "bg-blue-800 cursor-not-allowed" : "bg-blue-600 cursor-pointer hover:bg-blue-700"} transition-colors`}
                                            >
