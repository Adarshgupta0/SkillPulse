import AllQuiz from "../../components/admin/AllQuiz"
...
export default function AllquizPage() {
    ...
    const { adminquiz, setAdminQuiz, fetchAdminQuizProfile } = useContext(AdminQuizDataContext);


    useEffect(() => {
        fetchAdminQuizProfile();
    }, []);
                ...
                <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
                    ...
                    <header className="flex h-16 items-center gap-4 border-b bg-white px-4 lg:px-6">
                        <div className="flex items-center w-full bg-green-500-600 justify-between gap-2 ml-12 lg:ml-0">
                            <div>
                                <h1 className="text-lg font-semibold text-gray-900">Quizs</h1>
                            </div>
                    ...
                    <main className="flex-1 overflow-y-auto bg-gray-50 p-4 lg:p-6">
                        ...
                        <div className="max-w-7xl mx-auto space-y-8">
                            <AllQuiz quizzes={adminquiz} setquizs={setAdminQuiz} toastId={toastId} setToastId={setToastId} />
