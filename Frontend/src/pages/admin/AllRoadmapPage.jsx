import AllRoadmap from "../../components/admin/AllRoadmap"
...
export default function Page() {
    ...
    const { adminroadmap, setAdminRoadmap, fetchAdminRoadmapProfile } = useContext(AdminRoadmapDataContext);

    useEffect(() => {
        fetchAdminRoadmapProfile();
    }, []);
                ...
                <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
                    ...
                    <main className="flex-1 overflow-y-auto bg-gray-50 p-4 lg:p-6">
                        ...
                        <div className="max-w-7xl mx-auto space-y-8">
                            ...
                            {/* content */}
                            <AllRoadmap roadmaps={adminroadmap} setroadmaps={setAdminRoadmap} toastId={toastId} setToastId={setToastId} />
