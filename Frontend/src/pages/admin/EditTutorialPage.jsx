...
const EditTutorialPage = () => {
    ...
    const { admintutorial, setAdminTutorial } = useContext(AdminTutorialDataContext);
    ...
    useEffect(() => {
        const found = admintutorial.find((r) => r._id === id);
        if (found) {
            setlessons(found);
            reset(found);
        }
    }, [id, admintutorial, reset]);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axios.put(
                `${import.meta.env.VITE_BACKEND_URL}/admin/tutorial-update/${id}`,
                tutorialdata,
                { withCredentials: true }
            );

            if (response.data.success) {
                setAdminTutorial(response.data.alltutorial);
                reset();
                ...
                <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
                    ...
                    <header className="flex h-16 items-center gap-4 border-b bg-white px-4 lg:px-6">
                        <div className="flex items-center w-full bg-green-500-600 justify-between gap-2 ml-12 lg:ml-0">
                            <div className=''>
                                <h1 className="text-lg font-semibold text-gray-900">Edit Tutorial</h1>
                            </div>
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    name="title"
                                                    defaultValue={lessons ? lessons.title : ''}
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    id="description"
                                                    required
                                                    defaultValue={lessons ? lessons.description : ''}
                                                    name="description"
                                                    className="w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-sm outline-none "
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    id="channelname"
                                                    required
                                                    defaultValue={lessons ? lessons.channelname : ''}
                                                    name="tichannelnametle"
                                                    className="w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-sm outline-none "
                                                    placeholder="Enter channel name"
                                                    {...register("channelname", { required: { value: true, message: "channelname is required" } })}
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="url"
                                                    required
                                                    defaultValue={lessons ? lessons.link : ''}
                                                    id="link"
                                                    className="w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-sm outline-none"
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    id="roadmapType"
                                                    required
                                                    defaultValue={lessons ? lessons.tutorial_category : ''}
                                                    className="w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-sm outline-none"
                                                    {...register("tutorial_category", { required: { value: true, message: "roadmap_category is required" } })}
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    id="icon"
                                                    required
                                                    defaultValue={lessons ? lessons.icon : ''}
                                                    className="w-full px-3 py-2 border border-gray-300 bg-white text-gray-900 rounded-sm outline-none"
                                            ...
                                            <div className="pt-4 flex flex-col sm:flex-row gap-3">
                                                <button
                                                    type="submit"
                                                    disabled={loading}
                                                    className={`px-6 py-2 ${loading ? "bg-blue-800 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700 cursor-pointer"} trans text-white rounded-sm  font-medium`}
                                                >
