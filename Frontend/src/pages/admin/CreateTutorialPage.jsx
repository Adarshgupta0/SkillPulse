    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_BACKEND_URL}/admin/tutorial-create`,
                tutorialdata,
            ...
            if (response.data.success) {
                reset();
                setAdminTutorial([response.data.tutorial, ...admintutorial]);
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                            ...
                                            <div className="pt-4 flex flex-col sm:flex-row gap-3">
                                                <button
                                                    type="submit"
                                                    disabled={loading}
                                                    className={`px-6 py-2 ${loading ? "bg-blue-800 cursor-not-allowed" : "bg-blue-600 cursor-pointer hover:bg-blue-700"} text-white rounded-sm  font-medium`}
                                                >
